...
TARGET="src/components/DspPipeline.tsx"
cat > "$TARGET" << 'EOF'
...
EOF
git add "$TARGET"
git commit -m "fix(dsp): blockSize y sampleRate dinamicos desde params — quitar hardcoded 1024/48000"
git push origin main
echo "✅ DspPipeline pushed"
