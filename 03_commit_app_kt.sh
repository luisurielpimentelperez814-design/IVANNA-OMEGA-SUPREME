...
TARGET="app/src/main/java/com/ivanna/omega/core/IVANNAApplication.kt"
cat > "$TARGET" << 'EOF'
...
EOF
git add "$TARGET"
git commit -m "fix(socket): loop reconexion 5s + probe delay 500ms"
git push origin main
echo "✅ IVANNAApplication pushed"
