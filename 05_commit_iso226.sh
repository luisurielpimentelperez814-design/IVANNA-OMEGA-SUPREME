...
TARGET="src/components/Iso226CalibrationPanel.tsx"
...
EOF
git add "$TARGET"
git commit -m "feat(iso226): calibracion ISO 226:2003 completa — tabla af+Lu+Tf, formula Annex A, SVG curvas"
git push origin main
echo "✅ Iso226CalibrationPanel pushed"
