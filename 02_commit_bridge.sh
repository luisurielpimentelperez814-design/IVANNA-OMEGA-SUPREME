...
TARGET="app/src/main/java/com/ivanna/omega/magisk/OmegaEngineBridge.kt"
...
EOF
git add "$TARGET"
git commit -m "fix(socket): real probe en connect() + @Volatile + fallback legacy socket"
git push origin main
echo "✅ OmegaEngineBridge pushed"
